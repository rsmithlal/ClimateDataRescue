class BetterTogether::PostsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @better_together_post.save
        format.html { redirect_to @better_together_post, notice: 'Post was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @better_together_post.update(better_together_post_params)
        format.html { redirect_to @better_together_post, notice: 'Post was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to better_together_posts_url, notice: 'Post was successfully destroyed.' }
  ...
  private
    ...
    def set_better_together_post
      @better_together_post = BetterTogether::Post.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def better_together_post_params
      params.require(:better_together_post).permit(:bt_id)
    end
end
