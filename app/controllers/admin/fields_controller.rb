module Admin
  class FieldsController < AdminController
    ...
    private
    def field_params
      params.require(:field).permit(:internal_name, :field_key, :initial_value, :data_type, :html_field_type, :name, :validations, :full_name, :help, :field_group_id, :multi_select, :default_value)
    end
  end
end